    ...
    $(function() {
        $('#file_upload').uploadify({
            ...
            onUploadSuccess: function(file, data, response) {
                ...
                $("#imagePreviewContainer").html( '<div id="post-image-preview-new"><a id="delete-post-image-new" href="#delete-post-image"></a><img class="plug_img_new" src="<?php echo PLEX_PLUGIN_DIR ?>uploads/' + result.fileName + '" width="158"></div>' );
